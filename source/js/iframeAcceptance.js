    ...
    initIframes() {
        ...
        function markup(width, height, title, content, buttonText) {
            return `<div data-iframe-container style="height: ${height}; width:100%">
                <div class="u-level-top u-position--absolute u-align-middle u-padding__x--3 u-padding__y--3 u-flex-direction--column u-overflow--auto" data-suppressed-iframe style="width:${width};height:${height};backdrop-filter:blur(30px);display:flex;">
        ...
        function suppressIframes() {
            [...document.querySelectorAll('iframe')].forEach(iframe => {
                ...
                wrapper.insertAdjacentHTML('beforeend', markup(iframe.parentElement.classList.contains("embed") ? "100%" : iframe.width + "px", iframe.parentElement.classList.contains("embed") ? "100%" : iframe.height+"px", "title", "content", "buttonText"));
