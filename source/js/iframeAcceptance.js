    ...
    initIframes() {
        ...
        function markup(width, height, title, content, buttonText) {
            return `<div data-iframe-container style="height: ${height}px; width:100%">
                <div class="u-level-top u-position--absolute u-align-middle u-padding__x--3 u-padding__y--3 u-flex-direction--column u-overflow--auto" data-suppressed-iframe style="width:100%;height:${height}px;backdrop-filter:blur(30px);display:flex;">
