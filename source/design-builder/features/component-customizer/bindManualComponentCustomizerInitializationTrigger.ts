import { CUSTOMIZE_MANUAL_TRIGGER_SELECTOR } from '../../shared/constants/designBuilderRuntimeConstants';
...
export function bindManualComponentCustomizerInitializationTrigger(initializer: () => Promise<void>): () => void {
	...
	const clickTargets = Array.from(new Set(triggerRoots.flatMap((triggerRoot) => resolveInitializationClickTargets(triggerRoot))));
