...
const OUTER_PADDING_LABEL = 'Outer Padding Inset Multiplier';
...
const PREFOOTER_TEXT_ALIGNMENT_LABEL = 'Prefooter Text Alignment';
const SUBFOOTER_JUSTIFY_LABEL = 'Subfooter Justify Content';
