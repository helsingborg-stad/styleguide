...
class RequestTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        mkdir($this->tempBasePath . 'source/components/collapsiblesearch', 0777, true);
        ...
        file_put_contents($this->tempBasePath . 'source/components/collapsiblesearch/component.json', '{"name":"Collapsible Search","slug":"collapsiblesearch"}');
    ...
    protected function tearDown(): void
    {
        ...
        @unlink($this->tempBasePath . 'source/components/collapsiblesearch/component.json');
        ...
        @rmdir($this->tempBasePath . 'source/components/collapsiblesearch');
