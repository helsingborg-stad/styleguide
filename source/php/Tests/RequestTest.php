...
class RequestTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        mkdir($this->tempBasePath . 'source/components/collapsible-search', 0777, true);
        mkdir($this->tempBasePath . 'source/elements/blockquote', 0777, true);
        ...
        file_put_contents($this->tempBasePath . 'source/components/collapsible-search/component.json', '{"name":"Collapsible Search","slug":"collapsibleSearch"}');
        file_put_contents($this->tempBasePath . 'source/elements/blockquote/element.json', '{"name":"Blockquote","slug":"blockquote"}');
    ...
    protected function tearDown(): void
    {
        ...
        @unlink($this->tempBasePath . 'source/components/collapsible-search/component.json');
        @unlink($this->tempBasePath . 'source/elements/blockquote/element.json');
        ...
        @rmdir($this->tempBasePath . 'source/components/collapsible-search');
        @rmdir($this->tempBasePath . 'source/elements/blockquote');
        ...
        @rmdir($this->tempBasePath . 'source/elements');
    ...
    public function testResolvePageMapsMetadataSlugWhenComponentDirectoryNameDiffers(): void
    {
        $request = new Request('/components/collapsiblesearch', []);
    ...
    public function testResolvePageMapsElementSlugToElementView(): void
    {
