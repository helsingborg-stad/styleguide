...
const _ComponentCustomizerRuntime = class _ComponentCustomizerRuntime {
  ...
  modeSwitch;
  presetBarHost = null;
  hoverTipBarHost = null;
  menuDismissController = null;
  hoverTipVariable = null;
  hoverTipDescription = "";
  ...
  render() {
    ...
    this.hoverTipBarHost = root.querySelector("[data-hover-tip-bar]");
  ...
  findTipElement(target) {
    if (!(target instanceof Element)) {
      return null;
    }
    return target.closest("[data-tip-variable]");
  }
  setHoverTipFromElement(element) {
  ...
  handleControlTipPointerOver = /* @__PURE__ */ __name((event) => {
    this.setHoverTipFromElement(this.findTipElement(event.target));
  }, "handleControlTipPointerOver");
  handleControlTipPointerOut = /* @__PURE__ */ __name((event) => {
    ...
    this.clearHoverTip();
  }, "handleControlTipPointerOut");
  handleControlTipFocusIn = /* @__PURE__ */ __name((event) => {
    this.setHoverTipFromElement(this.findTipElement(event.target));
  }, "handleControlTipFocusIn");
  handleControlTipFocusOut = /* @__PURE__ */ __name((event) => {
    const currentElement = this.findTipElement(event.target);
    if (!currentElement) {
      return;
    }
...
const _FullPageEditorRuntime = class _FullPageEditorRuntime {
  ...
  render() {
    ...
    this.hoverTipBarHost = this.root.querySelector("[data-hover-tip-bar]");
    this.renderPresetBar();
    this.renderHoverTipBar();
  }
  destroy() {
