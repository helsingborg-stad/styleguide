...
const _ComponentCustomizerRuntime = class _ComponentCustomizerRuntime {
  ...
  findTokenLibrarySetting(tokenName) {
  ...
  resolveComponentSetting(componentName, availableTokenNames, setting) {
  ...
  buildLegacyTokenCategories(componentName, availableTokenNames) {
    const categories = [];
    for (const category of this.tokenLibrary.categories) {
  ...
  buildCategoriesForComponent(componentName) {
    ...
    for (const category of componentSettings) {
      const matchedSettings = category.settings.map((setting) => this.resolveComponentSetting(componentName, availableTokenNames, setting)).filter((setting) => setting !== null);
      this.appendCategory(categories, {
        id: category.id,
        label: category.label,
        description: category.description,
