...
import { f as normalizeDesignBuilderOverrideState, g as normalizeTokenOverrides, n as normalizeComponentOverrides, e as browserLocalStorageAdapter, A as ACTIVE_PRESET_KEY, C as COMPONENT_ACTIVE_PRESET_KEY, P as PRESETS_KEY, a as COMPONENT_PRESETS_KEY, G as GENERAL_SCOPE_KEY, N as NON_CUSTOMIZABLE_COMPONENTS, c as GLOBAL_SCOPE_KEY, S as SPLIT_STORAGE_KEY, d as MIN_SPLIT, M as MAX_SPLIT, i as isLocalStoragePersistenceEnabled, b as ComponentOverrideLocalStorageStore, T as TokenOverrideLocalStorageStore, h as hasOverrideStateData } from "../TokenOverrideLocalStorageStore.js";
...
const _ComponentCustomizerRuntime = class _ComponentCustomizerRuntime {
  ...
  renderControl(setting) {
    ...
    return createDesignBuilderControl(setting, currentValue, (variable, value, extraValues) => {
      this.handleChange(this.activeComponent, this.activeScopeKey, variable, value, setting.default, setting.linkedDefaults, extraValues);
    });
  }
  ...
  createLocalizedColorSelectionSetting(componentName, tokenName, setting, label, description, includeStateColors) {
  ...
  buildCategoriesForComponent(componentName) {
    ...
    for (const category of componentSettings) {
      const matchedSettings = category.settings.map((setting) => this.resolveComponentSetting(componentName, availableTokenNames, hiddenTokenNames, setting)).filter((setting) => setting !== null);
      this.appendCategory(categories, {
        id: category.id,
        label: category.label,
        description: category.description,
  ...
  handleChange(componentName, scopeKey, variable, value, defaultValue, linkedDefaults = {}, extraValues = {}) {
