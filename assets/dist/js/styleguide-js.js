...
var PopoverSetup$1 = /* @__PURE__ */ ((PopoverSetup2) => {
  ...
  PopoverSetup2["RelativeToTrigger"] = "data-js-popover-relative-to-trigger";
...
const _PopoverPositionCalculator = class _PopoverPositionCalculator {
  ...
  isRelativeToTrigger(popover) {
    const relativeToTrigger = popover.getAttribute(PopoverSetup$1.RelativeToTrigger)?.trim().toLowerCase();
