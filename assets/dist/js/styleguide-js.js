...
let Pagination$1 = (_a = class {
  ...
  paginateLinkListeners() {
    ...
    btns.forEach((btn) => {
      btn.addEventListener("click", (e) => {
        e.preventDefault();
        const next3 = e.target?.closest(`[${this.indexLinks}]`).getAttribute(this.indexLinks);
  ...
  sortAddButtons() {
    ...
    sortButtons.forEach((sortButton, index) => {
      ...
      sortButton.addEventListener("click", (event2) => {
        ...
        const buttonElement = event2.currentTarget;
